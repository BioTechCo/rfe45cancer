    ...
    <footer className="bg-gradient-to-r from-blue-800 to-blue-900 text-white">
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-4 text-blue-200 text-sm leading-relaxed">
              Advancing cancer research through DNA methylation analysis and innovative statistical methods.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cancer-types" className="text-blue-300 hover:text-white transition-colors duration-300">
                  Cancer Types
                </Link>
              </li>
              <li>
                <Link href="/analysis" className="text-blue-300 hover:text-white transition-colors duration-300">
                  Analysis
                </Link>
              </li>
            </ul>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-blue-100">Contact</h3>
            <address className="not-italic text-blue-200 text-sm">
              <p className="mb-2">Cancer Research Department</p>
              <p className="mb-2">research@rfe45cancer.org</p>
        ...
        <div className="border-t border-blue-700 mt-8 pt-6 text-center text-blue-300 text-sm">
          <p>© {currentYear} RFE45Cancer Research. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
