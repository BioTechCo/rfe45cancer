...
const FEATURE_COLORS = ['#8884D8', '#82CA9D', '#FFBB28', '#FF8042', '#0088FE', '#00C49F', '#FFBB28']; // Colors for feature bars
...
export default function DbetaPie({ 
  ...
  const dbetaData = data[validDataset] && data[validDataset][0]?.dbeta 
