...
<div className="methodology-explanation">
  <p>
    Extensive preprocessing of GSE199057 and TCGA-COAD methylation data was performed using the ChAMP package in R. 
...
<div style={{ display: 'flex', flexDirection: 'row', marginTop: '20px' }}>
    <div style={{ flex: 1, padding: '10px' }}>
        <DbetaPie dataset="GSE199057" dataset_name="GSE199057" />
    </div>
    <div style={{ flex: 1, padding: '10px' }}>
        <DbetaPie dataset="GDC_rectal_tissue_450k" dataset_name="TCGA-COAD" />
    </div>
</div>
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '20px' }}>
    <div style={{ display: 'flex', flexDirection: 'row', marginTop: '20px' }}>
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/rectal/planA/joined/section_5/hierarchical_clustering_simple_sum.png"
        ...
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/rectal/planA/joined/section_5/hierarchical_clustering_weighted_sum.png"
        ...
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/rectal/planA/joined/section_5/hierarchical_clustering_consensus.png"
    ...
    <ImageGallery 
        image="/rectal/planA/joined/section_5/hierarchical_clustering_compare.png"
...
|---------|--------|--------|--------|--------|----------|--------|-------------|-----------|----------|-----|
| Set | KRTAP24-1 | UNC5C | SHISA2 | ZNF793 | 0.992683 | 0.985366 | 1 | 1 | 0.992593 | 0.991077 |`} />
