...
<div style={{ display: 'flex', flexDirection: 'row', alignItems: 'stretch' }}>
    <div style={{ flex: 1, padding: '10px' }}>
        <ImageGallery 
            image="/prostate/vp_TCGA_PRAD.png"
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '20px' }}>
    <div style={{ display: 'flex', flexDirection: 'row', marginTop: '20px' }}>
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/prostate/planA/joined/section_5/hierarchical_clustering_simple_sum.png"
        ...
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/prostate/planA/joined/section_5/hierarchical_clustering_weighted_sum.png"
        ...
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/prostate/planA/joined/section_5/hierarchical_clustering_consensus.png"
    ...
    <ImageGallery 
        image="/prostate/planA/joined/section_5/hierarchical_clustering_compare.png"
