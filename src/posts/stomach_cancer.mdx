...
<div style={{ display: 'flex', flexDirection: 'row', alignItems: 'stretch' }}>
    <div style={{ flex: 1, padding: '10px' }}>
        <ImageGallery 
            image="/stomach/vp_TCGA_STAD.png"
            title="TCGA-STAD&GSE99553 Volcano Plot"
            alt="Volcano Plot"
        />
    </div>
    <div style={{ flex: 1, padding: '10px' }}>
        ...
        note that the GSE99553 dataset is merged with TCGA-STAD dataset, so the significance of the volcano plot lower compared to other cancer datasets.
    </div>
</div>
...
<div className="methodology-explanation">
  <p>
    Extensive preprocessing of GSE85464 and TCGA-STAD methylation data was performed using the ChAMP package in R. 
...
<div style={{ display: 'flex', flexDirection: 'row', marginTop: '20px' }}>
    <div style={{ flex: 1, padding: '10px' }}>
        <DbetaPie dataset="GSE85464" dataset_name="GSE85464" />
    </div>
    <div style={{ flex: 1, padding: '10px' }}>
        <DbetaPie dataset="GDC_stomach_and_GSE99553" dataset_name="TCGA-STAD" />
    </div>
</div>
...
<p>
    ...
    The joined dataset contains a total of <span style={{ backgroundColor: '#FFFF00' }}>72 gene</span>, whose similarity was calculated using GO (Gene Ontology) terms.
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '20px' }}>
    <div style={{ display: 'flex', flexDirection: 'row', marginTop: '20px' }}>
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/stomach/planA/joined/section_5/hierarchical_clustering_simple_sum.png"
        ...
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/stomach/planA/joined/section_5/hierarchical_clustering_weighted_sum.png"
        ...
        <div style={{ flex: 1, padding: '10px' }}>
            <ImageGallery 
                image="/stomach/planA/joined/section_5/hierarchical_clustering_consensus.png"
    ...
    <ImageGallery 
        image="/stomach/planA/joined/section_5/hierarchical_clustering_compare.png"
...
|---------|--------|--------|--------|--------|--------|-------------|-----------|----------|-----|
| Set | COL23A1 | HOXD8 | IMMP2L | 0.942857 | 0.980952 | 0.904762 | 0.911462 | 0.94482 | 0.980952 |`} />
